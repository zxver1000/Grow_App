    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        store.collection("회원정보").document(subemail).get()
            .addOnSuccessListener { result ->
                ...
                //레벨
                Log.d("", "${result.get("shape")} 끝")
                //shape
                if (result["shape"] == "Low_Weight") {
                    shape_i.setText("Low_Weight")
                ...
                } else if (result["shape"] == "Standard") {
                    shape_i.setText("Standard")
                ...
                } else if (result["shape"] == "Over_Weight") {
                    shape_i.setText("Over_Weight")
                ...
                } else if (result["shape"] == "Obesity") {
                    shape_i.setText("Obesity")
