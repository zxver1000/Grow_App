...
class YoutubeItemFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_youtube_item_list, container, false)
        return view
    }
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        yt_recyclerview.layoutManager=LinearLayoutManager(context,LinearLayoutManager.VERTICAL,false)
